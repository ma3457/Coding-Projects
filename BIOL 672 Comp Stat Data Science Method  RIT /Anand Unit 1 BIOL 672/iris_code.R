...
library('ggplot2')
library('reshape2')
# NOTE: install libraries with 'install.packages('PackageName') on the R console
...
data<-read.table("C:/Users/gabsbi/Desktop/code-examples/iris_R/iris_tab.txt",header=TRUE)
